"""Unit tests for the WinningMoveAIPlayer.

This module verifies the behavior of the WinningMoveAIPlayer, specifically ensuring that the AI
prioritizes immediate winning moves and falls back to random selection when no win is available.
"""
...
from src.players import WinningMoveAIPlayer
...
class TestWinningMoveAIPlayer(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        also prepares board states for testing both winning and non-winning scenarios.
        """
        ...
        # Board where 'O' (Player 1) can win at (0, 0)
        cls.winning_board = [
            [None, None, "X"],
            ["O", None, None],
            ["O", "X", None],
